...
Git integrations, diff viewers and forge helpers.

| Plugin | Description |
| --- | --- |
| [gitsigns.nvim](https://github.com/lewis6991/gitsigns.nvim) | Git hunks in the sign column: stage, reset, preview, blame, navigate. |
| [inlinediff-nvim](https://github.com/ofirgall/inlinediff-nvim) | Inline word-level diff highlighting within a hunk. |
| [neogit](https://github.com/ofirgall/neogit) | Magit-like git interface for staging, committing, pushing, etc. |
| [vim-fugitive](https://github.com/tpope/vim-fugitive) | Vim's classic git wrapper — commits, blame, logs, merges, index editing. |
